...
// import 'package:report_sarang/src/dashboard/widgets/date_range_picker_widget.dart';
...
class _FinancialSummaryDashboardState extends State<FinancialSummaryDashboard> {
  ...
  Widget _buildHeader(BuildContext context, FinancialCubit finanCubit) {
    ...
    return Row(
      ...
      children: [
        ...
        // SizedBox(
        //   width: 150, // Bounded width for DropdownButton2
        //   child: Column(
        //     children: [
        //       _buildDropdown(context),
        //       BlocSelector<FinancialCubit, FinancialState, String>(
        //         selector: (state) {
        //           if (state is FinancialSuccess) {
        //             return finanCubit.selectedDateRange;
        //           }
        //           return 'Pilih Tanggal'; // Default jika state belum `Loaded`
        //         },
        //         builder: (context, selectedDateRange) {
        //           return Visibility(
        //             visible: finanCubit.selectedPeriode != null,
        //             child: AppButton(
        //               padding: 9,
        //               backgroundColor: Colors.white,
        //               borderColor: const Color(0xFF999999),
        //               textColor: const Color(0xFF1A3A6D),
        //               onTap: () {
        //                 _pickDateRange();
        //               },
        ...
        // ),
        // SizedBox(
        //   width: 150, // Bounded width for AppButton
        //   child: BlocSelector<FinancialCubit, FinancialState, String>(
        //     selector: (state) {
        //       if (state is FinancialSuccess) {
        //         return finanCubit.selectedDateRange;
        //       }
  ...
  //     items: widget.period_type
  //     .map(
  //       (e) => DropdownMenuItem(value: e, child: Text(e)),
  //     ).toList(),
  //     value: finanCubit.selectedPeriode,
  //     hint: const Text('Pilih Periode'),
  //     onChanged: (value) {
  //       if (value != null) {
  //         finanCubit.updateSelectedPeriode(value);
  //         log('selectedPeriod: $value');
  //       }
  //     },
  //     style: GoogleFonts.outfit(
  //       fontSize: 14,
